...
class KernelSpatialModulation_Global(nn.Module):
    def __init__(self, in_planes, out_planes, kernel_size, groups=1, reduction=0.0625, kernel_num=4, min_channel=16,
        ...
        self.bn = nn.GroupNorm(1, attention_channel)  # 1 组 ≈ InstanceNorm
    ...
    def _forward(self, x):
        ...
        avg_x = self.relu(self.bn(self.fc(x).to(x.dtype)))
...
class FDConv(nn.Module):
    ...
    def forward(self, x):
        ...
        global_x = F.adaptive_avg_pool2d(x, 1).to(x.dtype)
